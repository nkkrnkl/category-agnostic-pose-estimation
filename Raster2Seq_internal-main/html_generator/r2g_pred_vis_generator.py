...
path_A = "r2g_vis/"
path_B = "cc5kmodel_r2g_test_preds/cubi_v4-1refined_poly2seq_l512_bin32_sem1_coo20_cls5_anchor_deccatsrc_smoothing_cls12_convertv2_t1/"
...
ids = [os.path.basename(f).replace('_pred_floorplan.png', '') for f in results_A2]
gt_files = [f'{path_A}/{_id}_gt.png' for _id in ids][:max_samples]
results_A2 = [f'{path_A}/{_id}_pred_floorplan.png' for _id in ids][:max_samples]
results_B2 = [f'{path_B}/{_id}_pred_floorplan.png' for _id in ids][:max_samples]
...
cols = [
    ...
    Col('img', 'Rastter2Graph Map', results_A2),     # specify image content for column 3
...
imagetable(cols, out_file='r2g_pred_vis.html', imsize=(512, 512))
