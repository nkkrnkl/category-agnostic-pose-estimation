"""
Training and evaluation engine for CAPE.
"""
import math
import sys
import os
...
def debug_log(message, force=False):
    ...
    Args:
        ...
        force: Whether to force printing
    """
...
def train_one_epoch_episodic(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for batch_idx, batch in enumerate(pbar):
        ...
        support_masks = batch['support_masks'].to(device, non_blocking=non_blocking)
...
def evaluate_cape(model, criterion, data_loader, device, compute_pck=True, pck_threshold=0.2):
    ...
    Args:
        ...
        device: Device
        compute_pck: Whether to compute PCK metric
            ...
            if pred_coords is not None:
                ...
                if gt_coords is not None and token_labels is not None:
                    ...
                    pck_evaluator.add_batch(
                        ...
                        bbox_widths=bbox_widths_pck,
                        bbox_heights=bbox_heights_pck,
...
def evaluate_unseen_categories(
    ...
    Returns:
        results: Dictionary with pck_overall, pck_mean_categories, pck_per_category,
                 total_correct, total_visible, num_categories
    """
    model.eval()
